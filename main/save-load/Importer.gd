...
var fezlvl: Dictionary = {"Triles" = null}
var fezts: Array
...
func _load() -> void:
	while true:
		...
		fezts = loadTS(fezlvl["TrileSetName"])
...
func load_lvl(path: String) -> Error: # Read fezlvl.json, return the JSON if valid.
...
func loadTS(tsName: String): # Load in trileset.
	...
	else: return [meshDict, mat, readTS.data]
